...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
		National  Morbidity Data Report
		<br>
			<small>(new lymphedema patients:stage of disease) </small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="#">Report</a></li>
			<li class="active">National  Morbidity Data Report</li>
		</ol>
	</section>
	...
	<section class="content">
		<div class="row">
			<form method="post" action="{{url('/national_new_lympoedema_stage_print') }}" target="blank">
			{{ 	csrf_field()  }}
				<div class="col-md-12">
