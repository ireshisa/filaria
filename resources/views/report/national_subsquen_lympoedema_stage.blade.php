...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		National Lymphedema Morbidity Report<br>
			<small>(Subsequent Visit Lymphedema patients-stage of disease ) </small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="#">Report</a></li>
			<li class="active">National New:Stage DATA</li>
		</ol>
	</section>
	...
	<section class="content">
		<div class="row">
			<form method="post" action="{{url('/national_subsequent_lympoedema_stage_print') }}" target="blank">
				{{ csrf_field()  }}
				<div class="col-md-12">
