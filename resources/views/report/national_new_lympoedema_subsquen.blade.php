...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			National Lymphedema Morbidity Report<br>
			<small>(subsequent visit  lymphedema patients- age and gender ) </small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="#">Report</a></li>
			<li class="active">National Lymphedema Morbidity Report :Age,Gender DATA</li>
		</ol>
	</section>
	...
	<section class="content">
		<div class="row">
			...
			<!-- left column -->
			<form method="post" action="{{url('/national_new_lympoedema_print_subsquen') }}" target="blank">
				{{csrf_field() }}
				<div class="col-md-12">
