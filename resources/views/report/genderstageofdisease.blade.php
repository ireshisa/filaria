...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
        District Morbidity  Data Report- New Lymphedema Patients
...
<br>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> New Lymphedema Patients</li>
        </ol>
    </section>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="col-md-8">
                                ...
                                <input type="hidden" name="report_type"  value="New Patient">
                                <!-- <div class="form-group mt-5">
                                    <label for="exampleInputPassword1">Report Type</label>
                                    <select required name="report_type" class="form-control" required="">
                                        <option value=""></option>
                                        <option value="New Patient"> New Patient </option>
                                        <option value="Subsequent Visits"> Subsequent Visits </option>
                                    </select>
                                </div> -->
