  ...
  <div class="content-wrapper">
      ...
      <section class="content">
          <div class="row">
              ...
              <!-- left column -->
              <form method="post" action="{{ url('/b1_report_print') }}" target="blank">
                              ...
                              <div class="col-md-8">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input data-date-format="yyyy-mm-d" required type="date" name="from"
                                          class="datepicker_v form-control pull-right" required="">
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group mt-5">
                                      ...
                                      <select required name="species" class="form-control" required="">
                                          <option value=""></option>
