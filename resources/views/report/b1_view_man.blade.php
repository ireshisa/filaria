<page>
    ...
    <table class="mr-auto mt-5" style="margin-left: 3px">
        <tr>


            <?php if ($type == 'srilanka') { ?>
                <th rowspan="2" style="padding: 3px">District</th>
            <?php         } ?>
            <th rowspan="2" style="padding: 3px">Form name</th>
            <th colspan="3" style="padding:3px">Area</th>
            <th colspan="3" style="padding: 3px">premises</th>
            <th class="tha" rowspan="2">catch time(hr)</th>
            <th class="tha" rowspan="2">Mosquito density (per man hr)</th>
            <th colspan="5" style="padding: 3px"><i>Mansonia</i></th>
            <th class="tha" rowspan="2">Infected rate</th>
            <th class="tha" rowspan="2">Infective rate</th>
        </tr>
        <tr>
            <th style="padding: 3px">MOH area</th>
            <th style="padding: 3px">PHM area</th>
            <th style="padding: 3px">GN division</th>
