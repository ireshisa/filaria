        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select class="js-example-basic-multiple  form-control " name="fild[]" multiple
                    ...
                    <option value="mosq_nets"> Preventive methods </option>
                        ...
                        <table id="ento2_table" class="table table-bordered table-hover">
                             ...
                             @endforeach
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <option {{$migrant->district=="Vavuniya" ?"selected":""}} value="Vavuniya"> Vavuniya</option>
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">your home town/village endemic for filariasis</label>
                               ...
                               <div class="form-group">
                                 <label for="exampleInputPassword1" >Occupation </label>
                                   <select name="occupation" id="#occupation" class="form-group">
	                                        ...
	                                        <option value="10" {{ $migrant->occupation=="10"?"selected":""}} >Other</option>
                                                                 ...
                                                                 <!-- <textarea  name="occupation" class="form-control" cols="4" rows="5">{{ $migrant->occupation }}</textarea> -->
                                 </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea  name="lymph" class="form-control" cols="4" rows="5">{{ $migrant->lymph }}</textarea>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">History of family or having lymphoedema</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">If Yes, when did you
                                                                    participate?</label>
                                                              <input type="date" name="mass_drug_when" value="{{ $migrant->mass_drug_when }}" data-date-format="yyyy-mm-d" class="datepicker_v form-control pull-right">
                                                            </div>
                              ...
                              <div class="form-group">
                                    <label for="exampleInputPassword1">Do you use mosquito nets to prevent from mosquito bites  Preventive methods used for mosquito bites</label>
                                  <select class="multiple-checkboxes form-control "  name="mosq_netsarray[]" multiple data-live-search="true">
                                        ...
                                        <option  <?php if (strpos($migrant->actions_taken, "8") !== false) {echo "selected";}?> value="8"> Other</option>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">DO you use any other
                                                                    preventive methods for
                                                                    mosquito bites at your present residence?</label>
                                                                <select name="mosq_prevent" class="form-control">
                                                                    <option value=""> </option>
                                                                    <option {{ $migrant->mosq_prevent=="Yes"?"selected":"" }} value="Yes">Yes</option>
                                                                    <option {{ $migrant->mosq_prevent=="No"?"selected":"" }} value="No">No</option>
                                                                </select>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">GPS
                                                                    Coordinate</label>
                                                                <div class="col-md-12">
                                                                    <div class="col-md-6">
                              ...
                              <div class="form-group">
                                    <label for="exampleInputPassword1">Antigen detection by ICT</label>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Antibody detection by ELISA</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-12"></div>
                                        <input type="date" value="{{ $migrant->date_of_examination }}"  name="date_of_examination" data-date-format="yyyy-mm-d" class="datepicker_v form-control ">
                                    </div>
                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-8">
                                                        <input type="text" name="treatment_given_DEC2" value="{{ $migrant->treatment_given_DEC2 }}"
                                                            class="form-control" placeholder="mg" />
                                                    </div>
                                                    <label for="inputPassword" class="col-sm-2 col-form-label rowinput">
                                                        mg/stat</label>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <label for="inputPassword" class="col-sm-2 col-form-label rowinput">
                                                        mg/stat</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">Name of PHFO/PHI collection blood film</label>
                                                                <input type="text" name="phfo_phi" value="{{ $migrant->phfo_phi }}" class="form-control">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1"> Name of PHLT examined the blood film</label>
                                                    ...
                                                    <div class="form-group">
                                                    <label for="exampleInputPassword1">Name of treating medical officer</label>
