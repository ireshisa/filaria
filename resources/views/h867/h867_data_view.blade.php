            ...
            <div class="col-xs-12">
                <div class="box">
                        ...
                        <table id="ento2_table" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th title="Result of blood film examination">Blood Examination</th>
                                    <th>Species</th>
                                    <th>Other</th>
                                    <th>MF count</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a onclick="return confirm('Are you sure Delete this record?')" href="{{ url('/delete_h867_data') }}/{{ $h867->id }}" class="btn btn-danger btn-sm"> <i class="fa fa-trash"></i> Delete</a>
                                    </td>
                                </tr>
                                <div id="editModal2{{$h867->id}}" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="post" action="{{ url('/h867_data_update ') }}">
                                                {{ csrf_field() }}
                    ...
                    <div class="form-group">
                         ...
                         <input value="{{$h867->age}}" type="text" name="age" class="form-control"  pattern="^\d*(\.\d{0,2})?$" />
                    </div>
