					...
					<table class="table table-bordered" id="tbl_posts">
						...
						<tbody id="tbl_posts_body">
							<tr id="rec-1">
								...
								<td rowspan="2"><input data-date-format="yyyy-mm-d" type="date" name="date[]" class="form-control"></td>
								<td rowspan="2"><input  type="number"   name="no_of_traps[]" class="form-control" onchange="TotalTrapLaid()" onkeyup="TotalTrapLaid()"></td> <!-- 					//new filed -->
								...
								<td rowspan="2"><input type="number" name="total_cx_quin[]" class="form-control" value="0" onchange="Total_CxQuin()" onkeyup="Total_CxQuin()"></td>
						...
						<tfoot>
							<tr>
								<td class="totalth" colspan="10" style="text-align: center; vertical-align: middle;"> Total</td>
					...
					<div class="box-body" style="overflow: hidden;">
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<input type="number" step="0.01" onkeyup="mosquitoCalculation('total_cx_quin_mosq','total_traps','mosquito_density_per_trap')" onchange="mosquitoCalculation('total_cx_quin_mosq','total_traps','mosquito_density_per_trap')" id="total_cx_quin_mosq" name="total_cx_quin_mosq" class="form-control">
							</div>
							...
							<div class="form-group">
								...
								<input onkeyup="mosquitoCalculation('total_cx_quin_mosq','total_traps','mosquito_density_per_trap')" onchange="mosquitoCalculation('total_cx_quin_mosq','total_traps','mosquito_density_per_trap')" type="number" id="total_traps" name="total_traps" class="form-control">
							</div>
							...
							<div class="form-group">
								...
								<input step=0.01 onclick="mosquitoCalculation('total_cx_quin_mosq','total_traps','mosquito_density_per_trap')" onchange="mosquitoCalculation('total_cx_quin_mosq','total_traps','mosquito_density_per_trap')" id="mosquito_density_per_trap" type="number" name="mosq_density_per_trap" class="form-control">
							</div>
	...
	<table id="sample_table">
		<tbody>
			<tr id="">
				...
				<td rowspan="2"><input type="text" name="serial_no[]" class="form-control"></td>
				<td rowspan="2"><input data-date-format="yyyy-mm-d" type="date" name="date[]" class="form-control"></td>
				<td rowspan="2"><input type="number" value="0"  name="no_of_traps[]" class="form-control"  onchange="TotalTrapLaid()" onkeyup="TotalTrapLaid()"></td> <!-- 					//new filed -->
				<td rowspan="2"><input type="text" name="phm_area[]" class="form-control"></td>
				<td rowspan="2"><input type="text" name="gn_division[]" class="form-control"></td>
				<td rowspan="2"><input type="text" name="chief_occupant[]" class="form-control"></td>
				<td rowspan="2"><input type="text" name="address[]" class="form-control"></td>
				...
				<td rowspan="2"><input type="number" name="thorax_mf[]" class="form-control" style="width: 40px;" value="0" onchange="TotalThoraxmf()" onkeyup="TotalThoraxmf()"></td>
				<td rowspan="2"><input type="number" name="thorax_l1[]" class="form-control" style="width: 40px;" value="0" onchange="TotalThoraxl1()" onkeyup="TotalThoraxl1()"></td>
				<td rowspan="2"><input type="number" name="thorax_l2[]" class="form-control" style="width: 40px;" value="0" onchange="TotalThoraxl2()" onkeyup="TotalThoraxl2()"></td>
				<td rowspan="2"><input type="number" name="thorax_l3[]" class="form-control" style="width: 40px;" value="0" onchange="TotalThoraxl3()" onkeyup="TotalThoraxl3()"></td>
