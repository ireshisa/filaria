...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
        ENTO 4 INDOOR FORM<br>
        <small>(To be filled for all fields) </small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">ENTO 4 INDOOR</a></li>
            <li class="active">ENTO 4 INDOOR FORM</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="row">
            <!-- left column -->
            <form method="post" action="{{url('/ento4_indoor_save') }}">
                {{csrf_field() }}
                <div class="col-md-12">
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="form-group col-md-3">
                                        <input type="Number" class="form-control" name="number[]" value="0" required />
                                    </div>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">No of baits</label>
                                    <input type="number"   name="noofbairs8_9" class="form-control" >
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1"> Temperature </label>
                                    <input type="text"   name="temp8_9" class="form-control" >
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1"> RH(%) </label>
                                ...
                                {{--     <div class="form-group">
                                    ...
                                    <input type="number"   name="pm_10_11" id="c5"
                                    class="form-control"  value="0">
                                </div> --}}
                                <div class="form-group">
                                    <label for="exampleInputPassword1">No of baits</label>
                                    <input type="number"   name="noofbairs10_11" class="form-control" >
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputPassword1"> Temperature </label>
                                    <input type="number"   name="temp10_11" class="form-control" >
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    <input type="number"   name="am_12_1" id="c7"
                                    class="form-control"  value="0">
                                </div> --}}
                                <div class="form-group">
                                    <label for="exampleInputPassword1">No of baits</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">No of baits</label>
                                    <input type="number"   name="noofbairs1_2"
                                    class="form-control"  >
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1"> Temperature </label>
                             ...
                             <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">No of baits</label>
                                    <input type="number"   name="noofbairs5_6" class="form-control" >
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1"> Temperature </label>
                               ...
                               <div class="form-group">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="form-group col-md-3">
                                        <input type="Number" class="form-control" name="number5_6[]" value="0" required />
                                    </div>
                                    <div class="form-group col-md-1">
                                        <input type="button" value="+" onclick="add(this)" class="form-control" />
                                    </div>
...
{{-- 2/1/2021 number filed removed (after time filed )--}}