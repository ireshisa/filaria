...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="/ento4_view">ENTO 4 OUTDOOR</a></li>
...
<td >
                                    ...
                                    <td>
                                        ...
                                        <a onclick="return confirm('Are you sure Delete this record?')" href="{{url('/delete_ento4_outdoor') }}/{{ $ento4->id }}" class="btn btn-danger btn-sm">
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title">EDIT ENTO 4 OUTDOOR</h4>
                                                <br />
                                            </div>
                                            <form method="post" action="{{ url('/ento4_outdoor_update') }}">
                                                {{ csrf_field() }}
 ...
 --}}
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" pattern="^\d*(\.\d{0,2})?$" value="{{$ento4->temp6_7}}" name="temp6_7" class="form-control" >
                                                            </div>
                                                            <div class="form-group">
             ...
             <div class="form-group">
                                    ...
                                    <select id="weather" name="weather_condition_6_7" class="form-control" required>
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="form-group col-md-8">
                                                                    <select name="mosq_spec_stat[]" class="form-control">
                                                                        <option value="{{$row->mosq_species}}">{{$row->mosq_species}}</option>
             ...
             <div class="form-group">
                                    <label for="exampleInputPassword1">Weather condition </label>
                                    <select id="weather" name="weather_condition_7_8" class="form-control" required>
                                     ...
                                     <div class="form-group col-md-3">
                                        <input type="Number" class="form-control" name="number7_8[]" required value="{{$row->mos_number}}" />
                                       </div>
                                                                @endforeach
                                                                @else
                                                                @endif
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    <input type="Number" class="form-control" name="number7_8[]" value="0" required />
                                                                </div>
                                                                <div class="form-group col-md-1">
                                                                    <input type="button" value="+" onclick="add(this)" class="form-control" />
                                                                </div>
            ...
            <div class="form-group">
                                    <label for="exampleInputPassword1">Weather condition </label>
                                    <select id="weather" name="weather_condition_8_9" class="form-control" required>
                                        ...
                                        <option value="Normal">Normal</option>
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    <input type="Number" class="form-control" name="number8_9[]" value="0" required />
                                                                </div>
                                                                <div class="form-group col-md-1">
                                                                    <input type="button" value="+" onclick="add(this)" class="form-control" />
                                                                </div>
        ...
        <div class="form-group">
                                    <label for="exampleInputPassword1">Weather condition </label>
                                    <select id="weather" name="weather_condition_9_10" class="form-control" required>
                                        ...
                                        <option value="Normal">Normal</option>
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    <input type="Number" class="form-control" name="number9_10[]" value="0" required />
                                                                </div>
                                                                <div class="form-group col-md-1">
                                                                    <input type="button" value="+" onclick="add(this)" class="form-control" />
                                                                </div>
        ...
        <div class="form-group">
                                    <label for="exampleInputPassword1">Weather condition </label>
                                    <select id="weather" name="weather_condition_10_11" class="form-control" required>
                                        ...
                                        <option value="Normal">Normal</option>
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    <input type="Number" class="form-control" name="number10_11[]" required value="{{$row->mos_number}}" />
                                                                </div>
                                                                @endforeach
                                                                @else
                                                                @endif
                                                       ...
                                                       {{--      <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1"> RH(%) </label>
                                                                <input type="number" pattern="^\d*(\.\d{0,2})?$" value="{{$ento4->RH11_12}}" name="RH11_12" class="form-control" >
                                                            </div>
                          ...
                          <div class="form-group">
                                    <label for="exampleInputPassword1">Weather condition </label>
                                    <select id="weather" name="weather_condition_11_12" class="form-control" required>
                                        ...
                                        <option value="Normal">Normal</option>
                                                        ...
                                                        {{--     <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">No of
                                                                baits</label>
                   ...
                   <div class="form-group">
                                    <label for="exampleInputPassword1">Weather condition </label>
                                    <select id="weather" name="weather_condition_12_1" class="form-control" required>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Weather condition </label>
                                    <select id="weather" name="weather_condition_1_2" class="form-control" required>
                  ...
                  <div class="form-group">
                                    <label for="exampleInputPassword1">Weather condition </label>
                                    <select id="weather" name="weather_condition_2_3" class="form-control" required>
                                        ...
                                        <option value="Normal">Normal</option>
                                                     ...
                                                     {{--        <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1"> RH(%) </label>
                                                                <input type="text" pattern="^\d*(\.\d{0,2})?$" value="{{$ento4->RH3_4}}" name="RH3_4" class="form-control" >
                                                            </div>
           ...
           <div class="form-group">
                                    <label for="exampleInputPassword1">Weather condition </label>
                                    <select id="weather" name="weather_condition_3_4" class="form-control" required>
                       ...
                       <div class="form-group">
                                    <label for="exampleInputPassword1">Weather condition </label>
                                    <select id="weather" name="weather_condition_4_5" class="form-control" required>
                                        ...
                                        <option value="Normal">Normal</option>
                                                          ...
                                                          {{--   <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1"> RH(%) </label>
                                                                <input type="number" pattern="^\d*(\.\d{0,2})?$" value="{{$ento4->RH5_6}}" name="RH5_6" class="form-control" >
                                                            </div>
                             ...
                             <div class="form-group">
                                    <label for="exampleInputPassword1">Weather condition </label>
                                    <select id="weather" name="weather_condition_5_6" class="form-control" required>
                                        ...
                                        <option value="Normal">Normal</option>
                                                   ...
                                                   {{--          <div class="form-group">
                                                                ...
                                                                <input type="text" id="totalValue" pattern="^\d*(\.\d{0,2})?$" value="{{$ento4->total}}" name="total" class="form-control" >
                                                            </div> --}}
                                                        </div>
                                                    </div>
                                                </div>
...
'<div class="form-group col-md-11">\n' +
    '<select name="' + $(btn).parent().prev().children().attr("name") + '" class="form-control">\n' +
        '<option value="">Select</option>\n' +
        '@foreach ($mosquito_list as $ms)\n' +
        '<option value="{{ $ms->data }}">{{ $ms->data }} </option>\n' +
        '@endforeach\n' +
